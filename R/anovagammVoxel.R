#' Computes analysis of variance tables for a Generalized Additive Mixed Effects Model on all voxels of a NIfTI image within a mask. 
#'
...
anovagammVoxel <- function(image, mask , fourdOut = NULL, formula, randomFormula, subjData, dispersion = NULL, 
